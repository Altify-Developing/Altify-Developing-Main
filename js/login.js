                    ...
                    return this.map((function (n) {
                                var t = function (e, n) {
                                    ...
                                    if (n && "function" == typeof btoa) {
                                        var o = (M = r, a = btoa(unescape(encodeURIComponent(JSON.stringify(M)))), u = "sourceMappingURL=data:application/json;charset=utf-8;base64,".concat(a), "")), i = r.sources.map((function (e) {
                                            return "")
                                    }));
