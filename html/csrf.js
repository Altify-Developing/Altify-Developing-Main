...
document.getElementById("csrfid4").innerHTML = ("<label for=csrfid'>cross-site request forgery token:</label><input type='hidden' id='csrfid' name='csrfid' value="+csrf3+"><br>");
