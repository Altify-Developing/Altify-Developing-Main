...
document.getElementById("csrfid4").innerHTML = ("<label for='csrfid'>cross-site request forgery token:</label><input type='shown' id='csrfid' name='csrfid' value="+csrf3+"><br>");
